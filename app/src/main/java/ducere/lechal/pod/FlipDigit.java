...
class FlipDigit implements AnimationListener {
	...
	private void setDigitImage(int digitToShow, boolean isUpper, ImageView image) {
		...
		case 0:
			if (isUpper)
				resource = R.mipmap.digit_0_upper;
			else
				resource = R.mipmap.digit_0_lower;

			break;

		case 1:
			if (isUpper)
				resource = R.mipmap.digit_1_upper;
			else
				resource = R.mipmap.digit_1_lower;

			break;

		case 2:
			if (isUpper)
				resource = R.mipmap.digit_2_upper;
			else
				resource = R.mipmap.digit_2_lower;

			break;

		case 3:
			if (isUpper)
				resource = R.mipmap.digit_3_upper;
			else
				resource = R.mipmap.digit_3_lower;

			break;

		case 4:
			if (isUpper)
				resource = R.mipmap.digit_4_upper;
			else
				resource = R.mipmap.digit_4_lower;

			break;

		case 5:
			if (isUpper)
				resource = R.mipmap.digit_5_upper;
			else
				resource = R.mipmap.digit_5_lower;

			break;

		case 6:
			if (isUpper)
				resource = R.mipmap.digit_6_upper;
			else
				resource = R.mipmap.digit_6_lower;

			break;

		case 7:
			if (isUpper)
				resource = R.mipmap.digit_7_upper;
			else
				resource = R.mipmap.digit_7_lower;

			break;

		case 8:
			if (isUpper)
				resource = R.mipmap.digit_8_upper;
			else
				resource = R.mipmap.digit_8_lower;

			break;

		case 9:
			if (isUpper)
				resource = R.mipmap.digit_9_upper;
			else
				resource = R.mipmap.digit_9_lower;
